...
SELECT ARTICULO, PROVEEDOR, EXISTENCIAS
FROM ARTICULOS
WHERE EXISTENCIAS IS NOT NULL 
  AND EXISTENCIAS <= ALL(SELECT EXISTENCIAS
			 FROM ARTICULOS)
/
