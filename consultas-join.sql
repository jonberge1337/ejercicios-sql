...
-- 4. Obtener de los artículos que han sido vendidos alguna vez (los que aparecen en los albaranes), su código, nombre y el n�mero de existencias del art�culo en el almac�n actualmente.
...
-- 9. Obtener los albaranes que contengan algún artículo que sea suministrado por algún proveedor vasco y a su vez que las existencias superen en el almacén el stock mínimo (bajo_minimo) en más de 10 unidades.

SELECT DISTINCT ALBARANES.ALBARAN, PROVINCIAS.DESCRIPCION
